        ...
        public abstract class AddInBase : IEdmAddIn5
        {
            ...
            public AddInBase()
            {
                ...
                System.Globalization.CultureInfo.CurrentCulture = new System.Globalization.CultureInfo("en-US");
                    m_AssmResolver = new Xarial.XToolkit.Helpers.AssemblyResolver(AppDomain.CurrentDomain, assemblyName);
                    m_AssmResolver.RegisterAssemblyReferenceResolver(
                        new Xarial.XToolkit.Reflection.LocalFolderReferencesResolver(System.IO.Path.GetDirectoryName(Assembly.GetCallingAssembly().Location),
                    ...
                    var callingAssembly = new FileInfo(Assembly.GetCallingAssembly().Location);
                
                OnLoadAdditionalAssemblies(callingAssembly.Directory);
            ...
            protected virtual void AddTaskSetupPages(ITaskPage[] taskSetupPages)
            {
            ...
            protected virtual void AddDetailTaskPage(ITaskPage taskDetailPage)
            {
                Application.EnableVisualStyles();
            ...
            public virtual void ForEachDatum(ref EdmCmdData[] affectedData, Action<EdmCmdData> Action)
            {
            ...
            public virtual void ForEachFile(ref EdmCmdData[] affectedData, Action<IEdmFile5> Action)
            {
                var taskInstance = poCmd.mpoExtra as IEdmTaskInstance;
            ...
            /// <param name="Action"></param>
            /// <remarks>This ignore EdmCmdData that are not files.</remarks>
            public virtual void ForEachFile(ref EdmCmdData[] affectedData, Action<IEdmFile5, IEdmFolder5> Action)
            {
                var taskInstance = poCmd.mpoExtra as IEdmTaskInstance;
            ...
            public virtual void GetAddInInfo(ref EdmAddInInfo poInfo, IEdmVault5 poVault, IEdmCmdMgr5 poCmdMgr)
            {
                try
                {
                    ...
                    var hookAtts = Helper.GetAttributes<ListenForAttribute>(this);
                       ...
                       var addedHooks = new List<EdmCmdType>();
